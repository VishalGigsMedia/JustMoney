...
import com.app.cent4free.R.string.shareAppText
...
import com.app.cent4free.common_helper.TrackingEvents.trackAppShared
import com.app.cent4free.common_helper.TrackingEvents.trackFBLikeClicked
import com.app.cent4free.common_helper.TrackingEvents.trackJoinTelegramClicked
...
class SettingsNewFragment : Fragment() {
    ...
    private fun manageClickEvents() {
        ...
        mBinding.clTelegram.setOnClickListener {
            ...
            trackJoinTelegramClicked("Settings")
        }
    ...
    private fun openFragment(fragment: Fragment, addToBackStack: Boolean = true) {
        if (addToBackStack) activity?.supportFragmentManager?.beginTransaction()?.replace(R.id.flMain, fragment)
